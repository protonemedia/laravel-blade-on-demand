...
description: Application integration guidance for protonemedia/laravel-blade-on-demand.
license: MIT
metadata:
  author: ProtoneMedia
---
...
## Overview
Use `protonemedia/laravel-blade-on-demand.` in a Laravel application.
...
- Activate when code references `protonemedia/laravel-blade-on-demand.` classes, facades, config, or documented features.
